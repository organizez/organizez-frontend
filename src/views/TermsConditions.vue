        ...
        <div class="termsConditions-background">
            <div class="termsConditions-container">
                <b-row class="row-termsConditions">
                    <p class="termsConditions-title">{{titleTermsConditions}}</p>
                </b-row>
                <b-row>
                    <p class="termsConditions-text">{{textTermsConditions}}</p>
                </b-row>     
            </div>
        </div>
        <Footer></Footer>
    ...
    methods: {
        ...
        getTermsConditions() {
            axios({
                ...
                this.textTermsConditions = result.data[0].text_terms_conditions
            })
        },
