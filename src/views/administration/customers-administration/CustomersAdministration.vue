      ...
      <b-row class="table-section">
        ...
        <b-row class="row-admin">
          <b-table bordered striped :fields="fieldsTable" :items="customers" :busy="isLoading" responsive="sm" class="customers-table">
              ...
              <template #head(county)>Județ</template>
 ...
 export default {
    ...
    data() {
      return {
        ...
        { key: 'name', label: 'Denumire'}, { key: 'location', label: 'Locație'}, { key: 'county', label: 'Județ'}, { key: 'website', label: 'Site'}, { key: 'phone', label: 'Telefon'}, { key: 'companyEmail', label: 'Email'}, { key: 'shortDescription', label: 'Descriere Scurtă'}, 
    ...
    methods: {
      ...
      deleteCustomer() {
        axios({
          method: 'delete',
          url: 'https://squid-app-q7qzv.ondigitalocean.app/be/customers/deleteCustomer/' + this.idDeletedCustomer + '/' + this.idDeletedCustomerService,
          mode: 'no-cors',
          headers: {
